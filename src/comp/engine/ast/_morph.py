"""AST node for morph operations - shape-based type transformations."""
...
class MorphOp(_base.ValueNode):
    ...
    def evaluate(self, frame):
        ...
        3. Call morph() from comp.run._morph with the value and shape
        ...
        """
        # Import morph function from run module
        from comp.run import morph
