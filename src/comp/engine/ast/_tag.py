...
from comp.engine._module import Module as RuntimeModule
...
class Module(_base.AstNode):
    ...
    def evaluate(self, frame):
        ...
        Creates a new Module and passes it through the mod_tags scope
        ...
        for op in self.operations:
            result = yield comp.Compute(op, mod_tags=module)
            if frame.is_fail(result):
                return result

        # Return the built module (or success marker)
